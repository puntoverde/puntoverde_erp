            ...
            <v-card>
                ...
                <v-card-text class="d-flex pt-5">
                    <v-item-group v-model="producto_salida_seleccionado">
                        <div style="min-width: 300px;height: calc(100vh - 150px); row-gap: 15px;"
                            class="warninxg px-5 d-flex flex-column">
...
import { getPedidosLibresService, saveEntradaAlmacenPedidoService, getProductosAlmacenService, getProductoExistenciaByIdService,saveSalidaAlmacenPedidoService } from '@/services/almacen_entrada_service'
