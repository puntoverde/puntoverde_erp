...
<div>
    <div class="d-flex justify-space-between">
      ...
      <h1 class="accent--text oswald--text">Reporte Entradas Almacen</h1>
    </div>
    ...
    <div class="d-flex justify-space-between mb-5">
      ...
      <Search v-model="search" :filters="filters" @emit-buscar="getEntradaReporte" >
...
import {ref} from 'vue'
import {getEntradaReporteService} from '@/services/reporte_almacen_service'
...
const headers = [
  ...
  { text: "Area solicita", align: "right", value: "area_departamento" },
  { text: "Area destino", value: "area_destino" },
  { text: "Proveedor", value: "nombre_comercial" },
  { text: "Clave producto", value: "producto_clave", align: "center" },
  { text: "Producto", value: "producto_servicio" },
  ...
  { text: "Fecha entrada", align: "center", value: "fecha_ingreso" },
  { text: "Factura cliente", align: "center", value: "factura", sortable: false },
];
...
const filters = ref([
  ...
  { label: "Persona genero", key: "solicita", value: "", type: "text" },
...
async function getEntradaReporte(filter={})
{
try {
    lst_almacen_entradas.value=await getEntradaReporteService(filter)
} catch (error) {
    console.log(error)
}
}
