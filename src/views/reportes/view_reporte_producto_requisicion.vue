...
<div>
    <div class="d-flex justify-space-between align-end mb-5 redx">
        ...
        <h1 class="accent--text oswald--text">Reporte produto requisicion</h1>
...
import {ref} from 'vue'
import {reporteProductoRequisicionService} from '@/services/producto_service'
...
const headers = [
  ...
  { text: "Compras realizadas", value: "cantidad_requisiciones" },  
  { text: "Cantidad de Producto comprado", value: "cantidad_comprada" },
  { text: "Fecha ultima compra", value: "fecha_ultima_compra", align: "center" },
  { text: "Ultima cantidad comprada", value: "ultima_cantidad_compra" },  
];
...
{
try {
  lst_productos.value=await reporteProductoRequisicionService(filter)
} catch (error) {
    console.log(error)
}
}
