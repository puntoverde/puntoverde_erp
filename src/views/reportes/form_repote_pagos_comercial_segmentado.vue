  ...
  >
    ...
    <template v-slot:activator="{ on }">
      <v-btn v-on="on" depressed tile :value="false" dark small class="mx-1">
        <v-icon color="white">mdi-account-group</v-icon> FACTURAR SEGMENTADA
      </v-btn>
    </template>
    ...
    <v-card tile>
      <v-toolbar color="primary" dark flat>
        <v-toolbar-title class="text-h3"
          >Factura Segmentada </v-toolbar-title
        >
        <v-spacer></v-spacer>
      ...
      <v-card-actions class="primary">
        ...
        <v-spacer></v-spacer>
        <v-btn v-if="tab == 0 && CFacturas" @click="tab = 1">Continuar</v-btn>
        <v-btn
